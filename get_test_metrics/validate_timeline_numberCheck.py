...
counterTimelineNotCorrectNumber = []
...
def get_timelines(iuns: list[str]) -> list:
    ...
    def read_info_for_one_iun_from_db( iun_and_index: dict) -> dict:
        global counterTimelineNotCorrectNumber
        ...
        if len(items)!= 16:
            counterTimelineNotCorrectNumber.append(iun)
...
if __name__ == '__main__':
    ...
    stats = {
        ...
        "totalUniqueIunsWithNonCorrectNumberOfElement": len(counterTimelineNotCorrectNumber),
        "UniqueIunsWithNonCorrectNumberOfElement": [element for element in counterTimelineNotCorrectNumber],
