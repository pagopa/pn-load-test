...
# RESTITUISCE UN REPORT CON QUANTE RICHIESTE SONO ANDATE IN 200, 500, ETC
# primo argomento: file sorgente status-by-request.json, secondo argomento directory di output
n_args=$#
if [ $n_args -lt 2 ]; then
...
total_5xx=$(grep '"statusCode":"5.*"' $1 | wc -l)
