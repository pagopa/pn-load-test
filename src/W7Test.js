...
export function internalRecipientSearch() {
    let url = `https://${webBasePath}/bff/v1/notifications/received?startDate=2014-06-27T00%3A00%3A00.000Z&endDate=2024-06-27T23%3A59%3A59.999Z&size=10`;
    ...
    let params = {
      ...
      'Origin':'https://cittadini.test.notifichedigitali.it',
      'Authorization': token,
...
export function internalSendNotification() {
    ...
    notificationRequest.recipients[0].physicalAddress.address = 'Via@OK_AR'; //address[exec.scenario.iterationInTest % address.length]
...
*/
export default function w7TestOptimized(onlySend,externalIun) {
